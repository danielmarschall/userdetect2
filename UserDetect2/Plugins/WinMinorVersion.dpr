...
const
  PLUGIN_GUID: TGUID = '{124264BB-E659-413B-A377-CAAD43C68725}';
...
begin
  stIdentifier := IntToStr(Win32MinorVersion);
...
begin
  ...
  if primaryLangID = LANG_GERMAN then
    stPluginName := 'Windows-Nebenversion'
  else
    stPluginName := 'Windows minor version';
...
begin
  stIdentificationMethodName := 'WinMinorVersion';
